...
namespace Settings {
	...
	float Skeletonchik[3] = { color.Yellow[0], color.Yellow[1], color.Yellow[2] };
	float SkeletonColor[3] = { color.Yellow[0], color.Yellow[1], color.Yellow[2] };
	float DBOX[3] = { color.MagentaRed[0], color.MagentaRed[1], color.MagentaRed[2] };
	float BoxCornerESP[3] = { color.MagentaRed[0], color.MagentaRed[1], color.MagentaRed[2] };
	float outline5[3] = { color.Black[0] , color.Black[1], color.Black[2] };
	float DBOXANDCONNERFILL[3] = { color.Black[0], color.Black[1], color.Black[2] };
	...
	float LineESP[3] = { color.Yellow[0], color.Yellow[1], color.Yellow[2] };
	float CrossHair[3] = { color.Red[0], color.Red[1], color.Red[2] };
	float SQ[4] = { color.white[0], color.white[1], color.white[2] };
	float LockLine[3] = { color.Red[0], color.Red[1], color.Red[2] };
	float Visible[3] = { color.Green[0], color.Green[1], color.Green[2] };
	float NonVisible[3] = { color.Red[0], color.Red[1], color.Red[2] };
